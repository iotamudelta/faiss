...
#define LD_NC_V1 
	//XXX"ld.global.cs.nc.u32"
#define LD_NC_V2 
	//XXX"ld.global.cs.nc.v2.u32"
#define LD_NC_V4 
	//XXX"ld.global.cs.nc.v4.u32"
#else
// Read normally
#define LD_NC_V1 
	//XXX"ld.global.cs.u32"
#define LD_NC_V2 
	//XXX"ld.global.cs.v2.u32"
#define LD_NC_V4 
	//XXX"ld.global.cs.v4.u32"
#endif // __CUDA_ARCH__
...
struct LoadCode32<1> {
    static inline __device__ void load(
            ...
            int offset) {
        p += offset * 1;
//XXX        asm("ld.global.cs.u8 {%0}, [%1];" : "=r"(code32[0]) : "l"(p));
    }
};
...
struct LoadCode32<2> {
    static inline __device__ void load(
            ...
            int offset) {
        p += offset * 2;
//XXX        asm("ld.global.cs.u16 {%0}, [%1];" : "=r"(code32[0]) : "l"(p));
    }
};
...
//XXX        asm("ld.global.cs.u8 {%0}, [%1 + 0];" : "=r"(a) : "l"(p));
//XXX        asm("ld.global.cs.u8 {%0}, [%1 + 1];" : "=r"(b) : "l"(p));
//XXX        asm("ld.global.cs.u8 {%0}, [%1 + 2];" : "=r"(c) : "l"(p));
...
struct LoadCode32<4> {
    static inline __device__ void load(
            ...
            int offset) {
        p += offset * 4;
//XXX        asm("ld.global.cs.u32 {%0}, [%1];" : "=r"(code32[0]) : "l"(p));
    }
};
...
struct LoadCode32<8> {
    static inline __device__ void load(
            ...
            int offset) {
        p += offset * 8;
//XXX        asm("ld.global.cs.v2.u32 {%0, %1}, [%2];"
//XXX            : "=r"(code32[0]), "=r"(code32[1])
//XXX            : "l"(p));
    }
};
...
struct LoadCode32<12> {
    static inline __device__ void load(
        ...
        // FIXME: this is a non-coalesced, unaligned, non-vectorized load
        // unfortunately need to reorganize memory layout by warp
//XXX        asm(LD_NC_V1 " {%0}, [%1 + 0];" : "=r"(code32[0]) : "l"(p));
//XXX        asm(LD_NC_V1 " {%0}, [%1 + 4];" : "=r"(code32[1]) : "l"(p));
//XXX        asm(LD_NC_V1 " {%0}, [%1 + 8];" : "=r"(code32[2]) : "l"(p));
    }
};
...
struct LoadCode32<16> {
    static inline __device__ void load(
            ...
            int offset) {
        p += offset * 16;
//XXX        asm("ld.global.cs.v4.u32 {%0, %1, %2, %3}, [%4];"
//XXX            : "=r"(code32[0]), "=r"(code32[1]), "=r"(code32[2]), "=r"(code32[3])
//XXX            : "l"(p));
    }
};
...
//XXX        asm(LD_NC_V1 " {%0}, [%1 + 4];" : "=r"(code32[1]) : "l"(p));
//XXX        asm(LD_NC_V1 " {%0}, [%1 + 8];" : "=r"(code32[2]) : "l"(p));
//XXX        asm(LD_NC_V1 " {%0}, [%1 + 12];" : "=r"(code32[3]) : "l"(p));
//XXX        asm(LD_NC_V1 " {%0}, [%1 + 16];" : "=r"(code32[4]) : "l"(p));
    }
};
...
struct LoadCode32<24> {
    static inline __device__ void load(
        ...
        // unfortunately need to reorganize memory layout by warp
//XXX        asm(LD_NC_V2 " {%0, %1}, [%2 + 0];"
//XXX            : "=r"(code32[0]), "=r"(code32[1])
//XXX            : "l"(p));
//XXX        asm(LD_NC_V2 " {%0, %1}, [%2 + 8];"
//XXX            : "=r"(code32[2]), "=r"(code32[3])
//XXX            : "l"(p));
//XXX        asm(LD_NC_V2 " {%0, %1}, [%2 + 16];"
//XXX            : "=r"(code32[4]), "=r"(code32[5])
//XXX            : "l"(p));
    }
};
...
//XXX        asm(LD_NC_V1 " {%0}, [%1 + 12];" : "=r"(code32[3]) : "l"(p));
//XXX        asm(LD_NC_V1 " {%0}, [%1 + 16];" : "=r"(code32[4]) : "l"(p));
//XXX        asm(LD_NC_V1 " {%0}, [%1 + 20];" : "=r"(code32[5]) : "l"(p));
//XXX        asm(LD_NC_V1 " {%0}, [%1 + 24];" : "=r"(code32[6]) : "l"(p));
    }
};
...
struct LoadCode32<32> {
    static inline __device__ void load(
        ...
        // unfortunately need to reorganize memory layout by warp
//XXX        asm(LD_NC_V4 " {%0, %1, %2, %3}, [%4];"
//XXX            : "=r"(code32[0]), "=r"(code32[1]), "=r"(code32[2]), "=r"(code32[3])
//XXX            : "l"(p));
//XXX        asm(LD_NC_V4 " {%0, %1, %2, %3}, [%4 + 16];"
//XXX            : "=r"(code32[4]), "=r"(code32[5]), "=r"(code32[6]), "=r"(code32[7])
//XXX            : "l"(p));
    }
};
...
//XXX            : "=r"(code32[4]), "=r"(code32[5])
//XXX            : "l"(p));
//XXX        asm(LD_NC_V2 " {%0, %1}, [%2 + 24];"
//XXX            : "=r"(code32[6]), "=r"(code32[7])
//XXX            : "l"(p));
//XXX        asm(LD_NC_V2 " {%0, %1}, [%2 + 32];"
//XXX            : "=r"(code32[8]), "=r"(code32[9])
//XXX            : "l"(p));
    }
};
...
//XXX            : "=r"(code32[8]), "=r"(code32[9])
//XXX            : "l"(p));
//XXX        asm(LD_NC_V2 " {%0, %1}, [%2 + 40];"
//XXX            : "=r"(code32[10]), "=r"(code32[11])
//XXX            : "l"(p));
//XXX        asm(LD_NC_V2 " {%0, %1}, [%2 + 48];"
//XXX            : "=r"(code32[12]), "=r"(code32[13])
//XXX            : "l"(p));
    }
};
...
//XXX              "=r"(code32[15])
//XXX            : "l"(p));
//XXX        asm(LD_NC_V4 " {%0, %1, %2, %3}, [%4 + 64];"
//XXX            : "=r"(code32[16]),
//XXX              "=r"(code32[17]),
//XXX              "=r"(code32[18]),
//XXX              "=r"(code32[19])
//XXX            : "l"(p));
//XXX        asm(LD_NC_V4 " {%0, %1, %2, %3}, [%4 + 80];"
//XXX            : "=r"(code32[20]),
//XXX              "=r"(code32[21]),
//XXX              "=r"(code32[22]),
//XXX              "=r"(code32[23])
